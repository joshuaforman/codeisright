...
3. From the server folder, run `node ./importscripts/import_quiz_language.js` and `node ./importscripts/import_quiz_ppd.js`. Note: you must have a mongoDB instance running on localhost for this to work.
4. From the server folder, run `node server.js`. This will run a node server on port 8090.
